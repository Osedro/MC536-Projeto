...
Você pode conferir as consultas SQL que estão no  [Query SQL do Projeto](https://github.com/Osedro/MC536-Projeto/blob/main/final/notebooks/verba_por_obito.ipynb), caso queira executá-las lance o binder através de um dos botões seguintes:  
[![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/Osedro/MC536-Projeto/HEAD)
...
Portal Brasileiro de Dados Abertos  | [Dados.gov.br](https://dados.gov.br/dataset/distribuicao-de-respiradores1) | Dados relacionados a gestão de recursos públicos, como gastos com equipamentos e insumos para saúde. Há dados voltados especificamente para covid.
